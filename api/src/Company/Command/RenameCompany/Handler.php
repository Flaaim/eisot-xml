 ...
 *  2. Трансформация примитива → Value Object Name (инварианты проверяются автоматически)
 *  3. Вызов метода агрегата — проверка инвариантов + запись события CompanyRenamed
